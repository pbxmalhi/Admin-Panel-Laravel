                ...
                <div class="col-md-10 main-section">
                    <section>
                        ...
                        <p class="bordered text-center" style="padding:3px">Click here to create
                            <a href="addproduct" style="text-decoration:underline; color:blue; font-size:12px">New Product</a>
                        </p>
                        <form method="post" action="{{url('searchProduct')}}">
                            ...
                            <table class="table1">
                                ...
                                <tr class="table-1-row">
                                    ...
                                    <td>
                                        <input type="text" style="height:20px; width:180px" name="pname">
                            ...
                            <table class="table2">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                       ...
                                       <td><img src="./upload/{{$data->productimage}}" height="100px" width="100px"></td>
                                       <td><a href="{{'editProduct/'.$data->id}}"><img src="./Images/edit.jpg"></a></td>
