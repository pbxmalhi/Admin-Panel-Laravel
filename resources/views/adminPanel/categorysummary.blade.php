            ...
            <div class="col-md-10 main-section">
                <section>
                    ...
                    <p class="bordered text-center" style="padding:3px">Click here to create
                        <a href="addcategory" style="text-decoration:underline; color:blue; font-size:12px">New Category</a>
                    </p>
                    <form method="post" action="{{url('searchcat')}}">
                        {{csrf_field()}}
                        <table class="table1">
                            ...
                            <tr class="table-1-row">
                                ...
                                <td>
                                    <input type="text" style="height:20px; width:180px" name="catname">
                        ...
                        <table class="table2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{'updateCategory/'.$data->id}}"><img src="./Images/edit.jpg"></a></td>
                                    <td><a href="{{'deleteCategory/'.$data->id}}">Delete</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
